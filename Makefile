...
palabosRoot  = ../../palabos
projectFiles = boatHullFormSolver.cpp
...
srcPaths = ../../palabos/src/extensions/pypal_palabos_extensions/boundary
# Path to external libraries (other than Palabos)
libraryPaths =
# Path to inlude directories (other than Palabos)
includePaths = ../../palabos/src/extensions ../../palabos/src/extensions/pypal_palabos_extensions
...
compileFlags = -Wall -Wnon-virtual-dtor #-DPLB_BSD
